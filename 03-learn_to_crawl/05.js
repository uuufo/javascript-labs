...
let greeting = "Howdy!";
let friend = "Luke";
let familyMember = "Talon";
let todayNum = "27";
let month = "May";
let year = "2021";
let myAge = "38";

console.log(greeting + " " + friend + ", it's " + myName);
console.log(greeting + ` ${familyMember}`);
console.log(greeting + " " + friend + ", today's date is: " + month + ` ${todayNum} ${year}.`);
console.log(`In 20 years, I will be ${+myAge + 20} old.`);